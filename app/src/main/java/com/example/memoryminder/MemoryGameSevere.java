...
public class MemoryGameSevere extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.memorygameeasy);
        ...
        new Handler().postDelayed(this::startTimer, 5000);
    }
    ...
    private void showAllTilesInitially() {
        ...
        new Handler().postDelayed(this::hideAllTiles, 3000);
    }
    ...
    private void endGame() {
        ...
        Intent intent = new Intent(MemoryGameSevere.this, GameOverActivityModerate.class);
