...
public class GameOverActivitySevere extends AppCompatActivity {
        ...
        patientStageRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if ("Severe".equalsIgnoreCase(patientStage)) {
                        saveGameResults("Severe");
                    } else {
    ...
    public void again(View view) {
        ...
        Intent intent = new Intent(GameOverActivitySevere.this, MemoryGameModerate.class); // Replace with your actual game activity
