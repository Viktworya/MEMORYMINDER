        ...
        reference.child(username).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (patient != null) {
                        storedPassword = patient.getPassword(); // Store the password for verification
                        if (storedPassword == null) {
                            Toast.makeText(ChangePassword.this, "Password data not available.", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(ChangePassword.this, "Patient data is null.", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(ChangePassword.this, "Patient does not exist.", Toast.LENGTH_SHORT).show();
                }
            }
